...
const MyTechCard = () => {
  const stack = [
    ...
    { name: "Spark", icon: "/tech-icons/spark.png" },
    { name: "MongoDB", icon: "/tech-icons/mongo.webp" },
    ...
    // { name: "Keras", icon: "/tech-icons/kera.png" },
    // { name: "OpenCV", icon: "/tech-icons/opencv.png" },
    ...
    // { name: "C/C++", icon: "/tech-icons/cpp.png" },
